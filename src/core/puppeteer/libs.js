...
function getTargetPageInstance(targetId) {
  if (!targetId || !this.__allInstance__) {
    return false
  }
  const page = Object.values(this.__allInstance__).find(instance => instance.$targetId === targetId)
